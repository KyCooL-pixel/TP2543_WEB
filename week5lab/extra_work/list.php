...
foreach($result as $row) {
  ...
  echo "How did you find me? : ".$row["How_did_you_find_me"]."<br>";
  echo "I like your: " . implode(', ', array_filter(["Front_page", "Form", "User_interface"], function($category) use ($row) { return $row[$category]; })) . "<br>";
