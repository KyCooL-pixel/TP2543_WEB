  ...
  <center>
    ...
    <table border="1">
      ...
      try {
        $conn = new PDO("mysql:host=$servername;dbname=$dbname", $username, $password);
        $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
        $sql = "SELECT * FROM tbl_orders_a123456, tbl_staffs_a123456, tbl_customers_a123456 WHERE ";
        $sql = $sql."tbl_orders_a123456.fld_staff_num = tbl_staffs_a123456.fld_staff_num and ";
        $sql = $sql."tbl_orders_a123456.fld_customer_num = tbl_customers_a123456.fld_customer_num";
