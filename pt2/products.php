...
<body>
  <center>
    ...
    <form action="products.php" method="post">
      ...
      Condition
      <input name="cond" type="radio" value="New" <?php if (isset($_GET['edit'])) if ($editrow['fld_product_condition'] == "New")
        echo "checked"; ?>> New
      <input name="cond" type="radio" value="Used" <?php if (isset($_GET['edit'])) if ($editrow['fld_product_condition'] == "Used")
        echo "checked"; ?>> Used <br>
      Manufacturing Year
      <select name="year">
