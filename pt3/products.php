        ...
        <form action="products.php" method="post" class="form-horizontal">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-9">
              <select name="brand" class="form-control" id="productbrand" required>
                ...
                <option value="Kawasaki" <?php if (isset($_GET['edit'])) if ($editrow['fld_product_brand'] == "Kawasaki")
                  echo "selected"; ?>>Kawasaki</option>
                <option value="Honda" <?php if (isset($_GET['edit'])) if ($editrow['fld_product_brand'] == "Honda")
                  echo "selected"; ?>>Honda</option>
                <option value="Suzuki" <?php if (isset($_GET['edit'])) if ($editrow['fld_product_brand'] == "Suzuki")
          ...
          <div class="form-group">
            ...
            <div class="col-sm-9">
              <div class="radio">
                <label>
                  <input name="cond" type="radio" id="productcond" value="New" <?php if (isset($_GET['edit'])) if ($editrow['fld_product_condition'] == "New")
                    echo "checked"; ?> required> New
                </label>
              </div>
              <div class="radio">
                <label>
                  <input name="cond" type="radio" id="productcond" value="Used" <?php if (isset($_GET['edit'])) if ($editrow['fld_product_condition'] == "Used")
                    echo "checked"; ?>> Used
                </label>
              </div>
            </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-9">
              <select name="year" class="form-control" id="productyear" required>
                <option value="">Please select</option>
                <option value="2013" <?php if (isset($_GET['edit'])) if ($editrow['fld_product_year'] == "2013")
                  echo "selected"; ?>>2013</option>
                <option value="2014" <?php if (isset($_GET['edit'])) if ($editrow['fld_product_year'] == "2014")
                  echo "selected"; ?>>2014</option>
                <option value="2015" <?php if (isset($_GET['edit'])) if ($editrow['fld_product_year'] == "2015")
      ...
      <div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
        ...
        <table class="table table-striped table-bordered">
          ...
          try {
            ...
            $stmt = $conn->prepare("select * from tbl_products_a189479 LIMIT $start_from, $per_page");
            $stmt->execute();
        ...
        <nav>
          <ul class="pagination">
            ...
            try {
              $conn = new PDO("mysql:host=$servername;dbname=$dbname", $username, $password);
              $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
              $stmt = $conn->prepare("SELECT * FROM tbl_products_a189479");
              $stmt->execute();
              $result = $stmt->fetchAll();
