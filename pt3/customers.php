...
<body>
  <center>
    ...
    <form action="customers.php" method="post">
      Customer ID
      <input name="cid" type="text" value="<?php if (isset($_GET['edit']))
        echo $editrow['fld_customer_num']; ?>"> <br>
      First Name
      <input name="fname" type="text" value="<?php if (isset($_GET['edit']))
        echo $editrow['fld_customer_fname']; ?>">
      <br>
      Last Name
      <input name="lname" type="text" value="<?php if (isset($_GET['edit']))
        echo $editrow['fld_customer_lname']; ?>">
      <br>
      Gender
      ...
      Phone Number
      <input name="phone" type="text" value="<?php if (isset($_GET['edit']))
