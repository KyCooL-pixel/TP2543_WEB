...
try {
  ...
  $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
    $stmt = $conn->prepare("SELECT * FROM tbl_orders_a189479, tbl_staffs_a189479,
      tbl_customers_a189479, tbl_orders_details_a189479 WHERE
      tbl_orders_a189479.fld_staff_num = tbl_staffs_a189479.fld_staff_num AND
      tbl_orders_a189479.fld_customer_num = tbl_customers_a189479.fld_customer_num AND
      tbl_orders_a189479.fld_order_num = tbl_orders_details_a189479.fld_order_num AND
      tbl_orders_a189479.fld_order_num = :oid");
  ...
  try {
    ...
    $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
      $stmt = $conn->prepare("SELECT * FROM tbl_orders_details_a189479,
        tbl_products_a189479 where 
        tbl_orders_details_a189479.fld_product_num = tbl_products_a189479.fld_product_num AND
        fld_order_num = :oid");
    $stmt->bindParam(':oid', $oid, PDO::PARAM_STR);
      $oid = $_GET['oid'];
    $stmt->execute();
