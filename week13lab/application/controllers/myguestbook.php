...
class MyGuestBook extends CI_Controller {
    ...
    public function __construct() {
        ...
        $this->load->model('myguestbook_model'); // Load the model here
    ...
    public function edit() {
        ...
        $recordExists = $this->myguestbook_model->recordExists($id);
    
        if (!$recordExists) {
            // Redirect to the last page or any specific page you want
            redirect(base_url('myguestbook/view'), 'refresh');
        }
